...
export const UI = {
  be: {
    ...
    tokenizer: 'Такенізатар',
    tokenizerPlaceholder: 'Увядзіце тэкст па-беларуску…',
    tokenizerHint: 'Кожны такен паказаны колерам у залежнасці ад тыпу.',
    tokenizerHintMorph: 'Кожны такен паказаны колерам. Для слоў паказана лема і часціна мовы.',
    tokensFound: 'такенаў',
    tokenTypes: 'тыпаў',
    wordsParsed: 'разабрана',
    tokenizerExamples: 'Прыклады тэксту:',
    tokenizerExampleTexts: [
      'Прывітанне, свет! Як справы? #мова',
      'Мінск — сталіца Беларусі. Насельніцтва: ~2 млн.',
      "што-небудзь з'есці па-беларуску",
      'Напішыце на info@example.com або https://belmorph.dev',
    ],
  },
  en: {
    ...
    tokenizer: 'Tokenizer',
    tokenizerPlaceholder: 'Enter Belarusian text…',
    tokenizerHint: 'Each token is color-coded by type.',
    tokenizerHintMorph: 'Each token is color-coded. Words show lemma and part of speech.',
    tokensFound: 'tokens',
    tokenTypes: 'types',
    wordsParsed: 'parsed',
    tokenizerExamples: 'Example texts:',
    tokenizerExampleTexts: [
      'Прывітанне, свет! Як справы? #мова',
      'Мінск — сталіца Беларусі. Насельніцтва: ~2 млн.',
      "што-небудзь з'есці па-беларуску",
